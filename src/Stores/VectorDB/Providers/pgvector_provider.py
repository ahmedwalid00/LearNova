from .vectordb_interface import VectorDBInterface , RetrievedDocument
from ..vectordb_enums import (DistanceMethodEnums, PgVectorTableSchemeEnums, 
                ...
                async with session.begin():
                    create_sql = sql_text(
                        f'CREATE TABLE {collection_name} ('
                            ...
                            f'FOREIGN KEY ({PgVectorTableSchemeEnums.CHUNK_ID.value}) REFERENCES lesson_chunks(chunk_id)'
                        ')'
                    )
